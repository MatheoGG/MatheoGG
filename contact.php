<?php 
	...
	#Your e-mail address
	define("__TO__", "administracion@aucasrl.com.ar");

	#Message subject
	define("__SUBJECT__", "Auca.srl = From:");

	#Success message
	define('__SUCCESS_MESSAGE__', "Tu mensaje ha sido enviado. ¡Gracias!");

	#Error message 
	define('__ERROR_MESSAGE__', "Error, tu mensaje no ha sido enviado");

	#Messege when one or more fields are empty
	define('__MESSAGE_EMPTY_FILDS__', "Por favor, completa todos los campos");
